...
Page({
  data: {
    ...
    achievements: [
      ...
      { id: 5, icon: '/images/achi-combo.png', name: '连击能手', desc: '单局连击≥20次', rule: 'combo>=20', cat: 'drum' },
      { id: 6, icon: '/images/achi-star1.png', name: '完美节拍', desc: '单局完美≥30次', rule: 'perfect>=30', cat: 'drum' },
      { id: 7, icon: '/images/achi-star2.png', name: '零失误', desc: '单局漏掉=0次', rule: 'miss===0', cat: 'drum' },
      { id: 8, icon: '/images/achi-highscore.png', name: '鼓王降临', desc: '获得最高级评价', rule: 'ratingS', cat: 'drum' },
